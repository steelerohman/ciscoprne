# Function that reads the device information from the file 'real-devices'
# Return a list of devices with information for each device stored in
# a dictionary
#
...
#-----------------------------------------------------------
# Function takes the ip address, username, password of the device
# as input parameters. Function is using pexpect to connect to the device
# If successful, the function should return the Pexpect 'session' object
# If unsuccessful, the function should return 0
#------------------------------------------------------------
...
# Function that runs 'show interface summary' on a device
