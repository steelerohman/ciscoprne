...
# def connect function connects to a device , returning the
...
# def show_int_summary function takes as input from pexpect session object
# and performs a 'show int brief' command to receive interface information
# from the device
#
#-----------------------------------------------------------
...
if __name__ == '__main__':
    ...
    # You can use your own IP and creds. This is just from class example
