# In this exercise, you will read IP route information from a device.
# You will allow a user to enter IP address prefixes
# and will display route information if the route was learned via OSPF.
#
#
import pexpect
import re
